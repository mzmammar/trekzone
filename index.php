...
<?php
  ...
  //selecting countries
  $countries =$conn->query("SELECT countries.id AS id, countries.name AS name, 
  countries.image AS image, countries.continent AS continent, countries.population AS population, countries.territory AS territory,
  countries.description AS description, AVG(cities.price) AS avg_price 
  FROM countries JOIN cities ON countries.id = cities.country_id GROUP BY(cities.country_id)");
  $countries->execute();
    ...
    <div class="content-slider">
     <?php foreach($allCountries as $country):   ?>
      ...
      <div class="slider">
       ...
       <?php foreach($allCountries as $country):   ?>
        <div id="top-banner-<?php echo $country->id; ?>" class="banner" style="background: url(./assets/images/banner-0<?= $country->id ?>.jpg) no-repeat center center; background-size: cover;">
